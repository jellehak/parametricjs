...
export default class ThreeBSP {
  ...
  toGeometry () {
    ...
    var polygon; var polygon_vertice_count
    var vertice_dict = {}
    var vertex_idx_a; var vertex_idx_b; var vertex_idx_c
    var vertex; var face
    var verticeUvs
...
class Polygon {
  ...
  classifySide (polygon) {
    var i; var vertex; var classification
    var num_positive = 0
    var num_negative = 0
  ...
  splitPolygon (polygon, coplanar_front, coplanar_back, front, back) {
    ...
    if (classification === COPLANAR) {
      ...
      var vertice_count
      var i; var j; var ti; var tj; var vi; var vj
      var t; var v
      var f = []
      var b = []
